...
[index]: !prev[index],
  ...
  return  courseData ? (
    <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-15 text-left bg-gradient-to-b from-cyan-100/70'>
...
<h1 className= "text-xl md:text-3xl font-semibold text-gray-800  ">{courseData.courseTitle}</h1>
<p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html:courseData.courseDescription.slice(0,200)}}></p>

{/* review and ratings */}
 <div className='flex items-center space-x-2 pt-3 pd-1 text-sm '>
