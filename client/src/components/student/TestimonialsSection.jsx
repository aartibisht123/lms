...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-4 md:px-16  '>
...
<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-10  mt-5 md:ml-40 md:mr-40  '>
  {dummyTestimonial.map((testimonial, index)=>(
    <div key={index} className='text-sm text-center
     border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden '>
