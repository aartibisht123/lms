...
<div className ='h-screen overflow-scroll flex flex-col items-start Justify-between nd:p-8 md:pb-0 p-4 pt-8 pb-0'>
...
<div className='flex flex-col gap-1'>
<p>Course Price</p>
<input onChange={e => setCoursePrice(e.target.value)} value={coursePrice} type="number" placeholder='0' className='outline-none md:py-2.5 ру-2 w-28 px-3 rounded border border-gray-500' required /> 
</div>
...
<span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target='_black' className='text_blue-500'>Link</a> - {lecture.isPreviewFree ? 'Free Preview' : 'Paid'}</span>
<img src={assets.cross_icon} alt="" onClick={()=> handleLecture('remove', chapter.chapterId, chapterIndex)} className='cursor-pointer'/>
  </div>
))}
...
<div className='mb-2'>
  ...
  <input
   type="text" 
   className='mt-1 black w-full border rounded pu-1 px-2'
